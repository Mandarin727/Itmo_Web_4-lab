        ...
        <div class="main_page">
            <section class="leftside">
                <div class="ava_actions">
                        <div class = "ava">
                            <img class = "img_big" src="<?php echo $item->img ?>" alt="">
                        </div>
                        ...
                        <ul class="friends">
                            <?php foreach($xml->item as $item) { ?>
                                <li class="friend img_hover">
                                    <img class="img_small" src="<?php echo $item->img ?>" alt="">
                                        <div class="name">
                                            <?php echo $item->name ?>
                                        </div>
                                </li>
            ...
            <section class="rightside">
                    <div class="about">
                        <div class="page_name">
                            <div class="nameofpage"> <?php echo $name ?> </div>
                    ...
                    <div class="info">
                        <div class="inf">
                            ...
                            <div class="inf2"> <?php echo $city ?> </div>
                        </div>
                        <div class="inf">
                            <div class="inf1">
                                День рождения:
                            </div>
                            <div class="inf2"> <?php echo $dateofbirth ?> </div>
                        </div>
                        <div class="inf">
                            <div class="inf1">
                                Семейное положение:
                            </div>
                            <div class="inf2"> <?php echo $position ?> </div>
                        </div>
                        ...
                        <ul class="records">
                            <li class="record">
                                <div class="record_left">
                                    <img class="img_small" src="<?php echo $img ?>" alt="">
                                </div>
